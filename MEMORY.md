...
- `fourier-cycles` now includes `tools/synthetic_superposition_check.py` for deterministic 5x sin/cos ground-truth extraction checks (known target periods vs recovered stable/selected cycles with hit-rate report).
