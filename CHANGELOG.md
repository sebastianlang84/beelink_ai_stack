...
## Unreleased
- mcp-transcript-miner: runs.start normalisiert `-`→`_` bei config_id (z. B. investing-test)
- mcp-transcript-miner: runs.start beantwortet requested/resolved config_id (klarer für Nutzer)
