...
def test_normalize_channel_namespace_prefers_raw_value() -> None:
    transcript_path = (
        "/tmp/output/investing/1_transcripts/CouchInvestor/2025-12-31_42RfznSu91o.txt"
    )
...
def test_normalize_channel_namespace_supports_legacy_channel_before_1_transcripts() -> None:
    transcript_path = "/tmp/output/investing/CouchInvestor/1_transcripts/2025-12-31_42RfznSu91o.txt"
